...
def main(pdf_path: str, character_name: str = "Dr. Wong", teaching_level: str = "Junior"):
    """Orchestrates the three agents to generate a complete role-playing prompt from a medical PDF."""
    
    # Initialize agents
    answer_extractor = AnswerExtractorAgent()
    scenario_generator = CaseScenarioGenerator()
    role_prompt_creator = RolePlayingPromptCreator()
    
    # Step 1: Extract raw text from PDF
    raw_text = answer_extractor.extract_text_from_pdf(pdf_path)
    
    # Step 2: Extract structured answers from the text
    extracted_data = answer_extractor.extract_answers(raw_text)
...
if __name__ == "__main__":
    pdf_path = "assets/medical_exercise/MEDU3400 HUF2-13 Interpretation of blood gases II 11-10-2023. stu (1) (1).pdf"  # Replace with actual file path
    main(pdf_path, character_name="Dr. Wong", teaching_level="Junior")
